    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)//when updating database you can migrate changes you update it alot so that if you
                        .Annotation("SqlServer:Identity", "1, 1"), //want changes it only changes the current data you are migrating.
